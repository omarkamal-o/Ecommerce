...
export default function ResetPassword() {
  ...
  let validationSchema = yup.object().shape({
    ...
    newPassword: yup
      ...
      .matches(
        /^[0-9a-z]{3,9}$/,
'Password must be between 3 and 9 characters long and contain only letters and numbers'
      )
  ...
  async function resetPasswordApi(formValues) {
    try {
      let request = await axios.put('https://ecommerce.routemisr.com/api/v1/auth/resetPassword', formValues);
